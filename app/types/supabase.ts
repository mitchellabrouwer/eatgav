  ...
  public: {
    ...
    Functions: {
      get_recipes_with_ratings: {
        Args: {
          ...
          _limit?: number
          _query?: string
          _cost?: Database["public"]["Enums"]["cost_type"]
          _difficulty?: Database["public"]["Enums"]["difficulty_type"]
          _occasion?: string
          _time_to_plate?: number
        }
        Returns: {
          id: string
          user_id: string
    ...
    Enums: {
      cost_type:
        ...
        | "expensive"
        | "really_expensive"
      difficulty_type: "very_easy" | "easy" | "moderate" | "hard" | "very_hard"
      occasion_type: "breakfast" | "lunch" | "dinner" | "snack" | "dessert"
    }
    CompositeTypes: {
      [_ in never]: never
    }
